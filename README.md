...
[Google Colab](https://colab.research.google.com/CK-Explorer/DuoSubs/blob/notebook/DuoSubs-webui.ipynb)
or 
...
With the [demo files](/demo/) provided, here are the simplest way to merge the subtitles:
